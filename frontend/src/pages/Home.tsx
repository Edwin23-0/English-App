...
const Home: React.FC = () => {
  ...
  <div className="benefitCards">
    ...
    <div className="card">
      <img src="src/assets/statistics.svg" alt="Stats Icon" className="icon" />
      <h3>Better Memory</h3>
      <span className="highlight">The forgetting curve is smaller and you remember the words.</span>
    </div>
    <div className="card">
      <img src="src/assets/fun.svg" alt="Fun Icon" className="icon" />
      <h3>Fun Interface</h3>
      <span className="highlight">Enjoy learning with gamified design.</span>
    </div>
  </div>
</section>
    </div>
